...
from Setting import *
from Utils import Event, WechatOCRUtils, Text
...
class ScreenshotTool(MainUI):
    def __init__(self):
        super().__init__()
        self.env = Env()
        self.wechat_ocr = WechatOCRUtils(self.screenshot)
    ...
    def on_release(self, event, resize=True) -> None:
        ...
        self.wechat_ocr.toggle_ocr_result_text(conceal=False)
    ...
    def rect_adjust(self, event) -> None:
        ...
        if self.adjust_rect.anchor_id != -1:
            self.wechat_ocr.destroy_ocr_result_text()
    ...
    def enter_adjust_mode(self, event) -> None:
        ...
        self.wechat_ocr.toggle_ocr_result_text(conceal=True)
    ...
    def clear_capture_info(self, _) -> None:
        ...
        self.edit_bar = None
        self.wechat_ocr.ocr_result_text = None
        gc.collect()
    ...
    def get_ocr_result(self, _):
        ...
        self.wechat_ocr.get_ocr_result(self.full_screenshot_canvas, image)
